...
export type EffectPhase = "map-preview" | "battle-ready" | "gene-config" | "exploration" | "battle-resolved";
...
export const EFFECTS: Record<string, GameEffect> = {
  ...
  "ability-forge": flaggingEffect("ability-forge", "gene-config", "鍛造師可以把目前裝備的基因格全部啟用。"),
