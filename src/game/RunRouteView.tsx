...
const NODE_LABELS: Record<MapNodeType, string> = { battle: "戰", elite: "菁", event: "事", relic: "遺", boss: "王" };
const NODE_NAMES: Record<MapNodeType, string> = { battle: "戰鬥", elite: "菁英", event: "事件", relic: "遺物", boss: "Boss" };
