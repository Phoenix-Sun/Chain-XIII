...
- **P1 首趟遠征未保證核心戰鬥教學：** 起始戰鬥節點被標記為已完成，且第一層可能只有事件／遺物／服務節點；需決定每趟首次流程是否固定展示短戰鬥，或至少保證地圖明確提供戰鬥入口與解釋。
以下仍未完成：戰鬥首屏次要資訊折疊、固定首趟戰鬥／新手教學契約、完整 390×844 Cloudflare 實站驗收，以及更完整的 end-to-end reload 人工 click-through。
