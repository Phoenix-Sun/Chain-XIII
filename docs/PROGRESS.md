...
| P3 | 可操作單場戰鬥、角色能力、敵 AI | 🟡 戰鬥完成、角色技能第一批接入 | 13 張批次分墩、敵 AI、三墩結果與節點回寫已接；水紋、風之預視、火花、四象與風行商人已有 Run 內操作入口，其餘角色 Effect 待接 |
...
19. 風行商人已接入事件 phase，可消耗一次性 Effect 重擲本事件骰，並透過 `discoveredRunFlags` 持久化使用狀態。
