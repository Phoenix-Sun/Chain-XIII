...
| P3 | 可操作單場戰鬥、角色能力、敵 AI | 🟡 戰鬥完成、角色技能第一批接入 | 13 張批次分墩、敵 AI、三墩結果與節點回寫已接；水紋、風之預視、火花、四象、風行商人、石碑揭示與鍛造師保留素材已有 Run 內操作入口；潮汐流轉與其餘角色 Effect 待接 |
...
1. 將潮汐流轉接入完成牌局後的元素墩調整流程，讓不同隊伍產生不同解法而不只是提示文字。
2. 擴充神器與探索骰的內容分歧，讓不同事件目標與更多角色 Effect 影響事件結果。
